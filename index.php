...
<article class="u-hero-slide is-active"><div class="u-hero-inner c-hero-grid"><div><div class="u-eyebrow"><?= e(tr('TRADITION MEETS INNOVATION: EST. 1887')) ?></div><h1><?= e(tr('Nurturing global leaders.')) ?></h1><p class="c-hero-sub">Quality Pharmacy Education | Research Driven Learning | Community Healthcare</p><p><?= e($brand) ?> <?= e($siteLang === 'hi' ? 'सत्यापित प्रवेश, स्नेही शिक्षकों और आधुनिक छात्र पोर्टल के साथ फार्मेसी व संबद्ध चिकित्सा कार्यक्रम प्रदान करता है।' : 'offers ' . $brandKind . ' programs with verified admissions, caring faculty and a modern student portal.') ?></p><div class="u-cta"><a class="u-btn solid big" href="apply.php"><?= e(tr('Apply for Admission')) ?> →</a><a class="u-btn ghost big" href="?page=courses"><?= e(tr('Explore Programs')) ?> →</a></div></div><div class="c-hero-img"><img src="assets/college-hero.jpg" alt="<?= e($brand) ?> campus"></div></div></article>
<article class="u-hero-slide"><div class="u-hero-inner c-hero-grid"><div><div class="u-eyebrow">YOUR NEXT CHAPTER STARTS HERE</div><h1>Find your place to grow.</h1><p class="c-hero-sub">Admissions open · Apply online</p><p>Explore open programs, see the latest admission dates and begin your application in minutes.</p><div class="u-cta"><a class="u-btn solid big" href="?page=courses">Explore Programs →</a><a class="u-btn ghost big" href="?page=admissions">How to join</a></div></div><div class="c-hero-img"><img src="assets/program-bpharm.jpg" alt="Students in the pharmacy laboratory"></div></div></article>
<article class="u-hero-slide"><div class="u-hero-inner c-hero-grid"><div><div class="u-eyebrow">ONE SECURE FRONT DOOR</div><h1>Everything starts here.</h1><p class="c-hero-sub">One email · Every portal</p><p>Use one secure email verification flow to return to your admissions journey or campus portal.</p><div class="u-cta"><a class="u-btn solid big" href="?page=login">Open sign in →</a><a class="u-btn ghost big" href="?page=contact">Contact the institute</a></div></div><div class="c-hero-img"><img src="assets/program-mpharm.jpg" alt="Pharmaceutical research laboratory"></div></div></article>
...
<div><div class="u-eyebrow">Welcome to</div><h2><?= e($brand) ?></h2><p><?= e($brand) ?> is committed to quality pharmacy education, research and ethical healthcare practice. Our mission is to prepare students with knowledge, skills and values for a rapidly evolving healthcare industry.</p><p><a class="u-btn solid" href="?page=about">Know More About Us →</a></p></div>
<div><aside class="c-quote"><span class="c-quote-mark">“</span><blockquote>Dream is not that which you see while sleeping, it is something that does not let you sleep.</blockquote><cite>— Dr. A.P.J. Abdul Kalam</cite></aside></div>
...
<section class="u-section c-programs"><div class="c-sec-head"><h2>Our Programs</h2><a href="?page=courses">View All Programs →</a></div><?php if (!$programs): ?><p class="u-muted"><?= e(tr('Admissions are opening soon.')) ?> <?= e(tr('Check')) ?> <a href="?page=notices"><?= e(tr('Notices')) ?></a> <?= e(tr('or contact the office.')) ?></p><?php else: ?><div class="c-prog-cards"><?php foreach (array_slice($programs, 0, 4) as $p): ?><article><img src="<?= e(collegeProgramImage($p['name'])) ?>" alt="" loading="lazy"><div class="c-prog-body"><div class="u-eyebrow"><?= e($p['institute_name']) ?></div><h3><?= e($p['name']) ?></h3><p class="u-meta"><?= e($p['duration']) ?> · PCI Approved</p><p class="u-fee">₹<?= number_format((int)$p['fee_minor'] / 100, 2) ?></p><p class="u-apply-by"><?= e(tr('Apply by')) ?> <?= e($p['closes_on']) ?></p><a class="u-btn solid" href="student.php?page=course&course=<?= (int)$p['id'] ?>">Learn More →</a></div></article><?php endforeach; ?></div><p class="u-more"><a href="?page=courses"><?= e(tr('View all')) ?> <?= count($allPrograms) ?> <?= e(tr('programs')) ?> →</a></p><?php endif; ?></section>
<div class="u-stats-band"><div><?php foreach ($stats as [$n, $label, $plus]): ?><div><strong><?= (int)$n ?><?= $plus ? '+' : '' ?></strong><span><?= e($label) ?></span></div><?php endforeach; ?></div></div>
<div class="c-duo c-wrap">
<section class="u-section"><div class="c-sec-head"><h2>Campus Life</h2><a href="?page=about">View Gallery →</a></div><div class="c-tiles"><div class="c-tile t1"><span>📚</span><strong>Learning</strong></div><div class="c-tile t2"><span>🔬</span><strong>Innovation</strong></div><div class="c-tile t3"><span>🤝</span><strong>Community Service</strong></div><div class="c-tile t4"><span>🏏</span><strong>Beyond Classroom</strong></div></div></section>
<section class="u-section"><div class="u-eyebrow"><?= e(tr("Vice-Chancellor's Message")) ?></div><h2><?= e(tr("Vice-Chancellor's Message")) ?></h2><div class="u-vc-full"><span class="u-vc-portrait"><?= e(strtoupper(mb_substr($brand, 0, 1))) ?></span><div><blockquote>“<?= e($vcMsg) ?>”</blockquote><cite><?= e(tr('Office of the Vice-Chancellor')) ?> · <?= e($brand) ?></cite><p><a class="u-btn solid" href="?page=about">Read More →</a></p></div></div></section>
</div>
<section class="u-section"><div class="c-sec-head"><h2><?= e(tr('Explore our programs')) ?></h2></div><div class="u-prog-grid"><?php $pi = 0; foreach (siteShowcasePrograms() as $sp): $pi++; ?><a class="u-prog-card u-prog-<?= $pi ?>" href="?page=courses"><span><?= e($sp) ?></span></a><?php endforeach; ?></div><?php if ($programs): ?><p class="u-more"><a href="?page=courses"><?= e(tr('All programs')) ?> →</a></p><?php else: ?><p class="u-muted"><?= e(tr('Programs open here when admissions begin.')) ?></p><?php endif; ?></section>
<section class="u-section" id="placement"><div class="c-sec-head"><h2><?= e(tr('Top recruiters')) ?></h2></div><div class="u-recruiters"><?php foreach (siteRecruiters() as [$icon, $name]): ?><span><?= $icon ?> <?= e($name) ?></span><?php endforeach; ?><span class="u-flag-tile"><?= siteFlag() ?> India</span></div></section>
