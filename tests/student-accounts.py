...
with tempfile.TemporaryDirectory(prefix='northstar-student-accounts-') as temp:
    ...
    try:
        ...
        check('Student accounts' in owner.get('index.php?page=student-accounts') and 'newstudent@example.test' in owner.html,'staff can list self-registered accounts')
        ...
        check('Linked' in owner.get('index.php?page=student-accounts'),'staff list shows the portal link')
