...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Northstar · Institute CRM</title><link rel="stylesheet" href="assets/app.css"><?php if(!$user): ?><link rel="stylesheet" href="assets/home.css"><?php endif; ?><script src="assets/app.js" defer></script></head><body>
<?php if(!$user):
$homeCourses=[];
...
?>
<div class="home">
<div class="home-strip"><span>Admissions open &middot; D.Pharm &amp; allied medical programs</span><span class="home-strip-links"><a href="student.php">Student Login</a> &middot; <a href="#office-login">Office Login</a></span></div>
<header class="home-header"><a class="home-brand" href="?"><span class="home-brand-mark">+</span><span>Northstar<em>Institutions</em></span></a><nav class="home-nav" aria-label="Homepage"><a href="#courses">Courses</a><a href="#institutes">Institutes</a><a href="apply.php">Admissions</a><a href="#contact">Contact</a></nav><div class="home-login-btns"><a class="home-btn ghost" href="student.php">&#127891; Student Login</a><a class="home-btn solid" href="#office-login">&#128188; Office Login</a></div></header>
<section class="home-hero"><div class="home-hero-text"><div class="home-eyebrow">DIPLOMA IN PHARMACY (D.PHARM) &middot; ADMISSIONS OPEN</div><h1>Your pharmacy career starts here.</h1><p>Explore D.Pharm and allied medical programs, create your free student account, and apply online &mdash; then track your application to the office decision.</p><div class="home-cta"><a class="home-btn solid big" href="apply.php">Apply for Admission <span>&rarr;</span></a><a class="home-btn ghost big" href="#courses">Explore Courses</a><a class="home-btn ghost big" href="student.php?page=register">Create Student Account</a></div><div class="home-stats"><div><strong><?=count($homeInstitutes)?></strong><span>Institutes</span></div><div><strong><?=count($homeCourses)?></strong><span>Courses open</span></div><div><strong><?=count($homeCities)?></strong><span>Cities</span></div></div></div><div class="home-hero-card" aria-hidden="true"><div class="home-hero-cross">+</div><p>D.Pharm<br><span>Pharmacy &amp; Medical<br>Programs</span></p></div></section>
