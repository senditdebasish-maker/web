...
<p class="login-note">Need an account? Contact your institute administrator.<br>First time setting up? Follow the README installation guide.<br><a href="student.php">Student? Open your student portal →</a></p></main></div>
<?php else:
try {
