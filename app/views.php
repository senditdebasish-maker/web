...
<header class="home-header"><a class="home-brand" href="?"><span class="home-brand-mark">+</span><span>Northstar<em>Institutions</em></span></a><nav class="home-nav" aria-label="Homepage"><a href="#courses">Courses</a><a href="#institutes">Institutes</a><a href="apply.php">Admissions</a><a href="#contact">Contact</a></nav><div class="home-login-btns"><button class="theme-toggle" data-theme-toggle type="button" aria-label="Toggle dark mode" title="Toggle dark mode"><span aria-hidden="true">🌙</span></button><a class="home-btn ghost" href="student.php">&#127891; Student Login</a><a class="home-btn solid" href="#office-login">&#128188; Office Login</a></div></header>
