...
<?php $siteBrand=siteBrand(); ?>
<?=siteHeader($siteBrand[0],$siteBrand[1],'home','<a class="u-btn ghost" href="student.php">🎓 Student Login</a><a class="u-btn solid" href="#office-login">💼 Office Login</a>')?>
