...
if(in_array($page,['staff','audit','payments','notifications','teachers','batches','attendance','fee-plans','fee-reports','health','exams','announcements','support','applications'],true) && !$admin) { http_response_code(403); $page='forbidden'; }
