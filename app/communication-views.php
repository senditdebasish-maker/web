...
<section class="panel"><div class="panel-heading"><div><h2>Online payment orders</h2><p>Verify in the Razorpay dashboard before reconciling. Test orders never credit the ledger. Webhook: <code>razorpay-webhook.php?institute=&lt;id&gt;</code>.</p></div></div><?php if(!$online):?><div class="empty"><p>No online orders yet. Students create orders from their portal when their institute is configured.</p></div><?php else:table(['Order / student','Amount / mode','State / receipt','Captures','Reconcile'],$online,function($o){
