...
5. Match counts and totals for institutes, users, enquiries, students, payments, documents, fee plans, attendance, exams, notices and support conversations against a record captured at backup time. Test at least two institutes and student access isolation.
